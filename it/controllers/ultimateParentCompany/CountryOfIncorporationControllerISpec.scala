...
class CountryOfIncorporationControllerISpec extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers {
  ...
  "in Normal mode" when {
    ...
    "GET /ultimate-parent-company/1/country-of-incorporation" when {
      ...
      "user is authorised" should {
        ...
        "user answer for parent company name exists" should {
          ...
          "return OK (200)" in {
            ...
            val res = getRequest("/ultimate-parent-company/1/country-of-incorporation")()
    ...
    "POST /ultimate-parent-company/1/country-of-incorporation" when {
      ...
      "user is authorised" when {
        ...
        "enters a valid country " should {
          ...
          "redirect to check answers page" in {
            ...
            val res = postRequest(
              "/ultimate-parent-company/1/country-of-incorporation",
        ...
        "enters an invalid country" should {
          ...
          "return a BadRequest" in {
            ...
            val res = postRequest("/ultimate-parent-company/1/country-of-incorporation", Json.obj("value" -> "Invalid Country"))()
      ...
      "user is authorised" when {
        ...
        "user answer for parent company name exists" should {
          ...
          "return OK (200)" in {
            ...
            val res = getRequest("/ultimate-parent-company/1/country-of-incorporation/change")()
