...
class ParentCompanySAUTRControllerISpec extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers with BaseITConstants {
  ...
  "in Normal mode" when {
    ...
    "GET /ultimate-parent-company/1/sautr" when {
      ...
      "user is authorised" should {
        ...
        "user answer for parent company name exists" should {
          ...
          "return OK (200)" in {
            ...
            val res = getRequest("/ultimate-parent-company/1/sautr")()
    ...
    "POST /ultimate-parent-company/1/sautr" when {
      ...
      "user is authorised" when {
        ...
        "enters a valid answer" should {
          ...
          "redirect to check answers page" in {
            ...
            val res = postRequest("/ultimate-parent-company/1/sautr", Json.obj("value" -> "1111111111"))()
        ...
        "enters an invalid answer" when {
          ...
          "return a BAD_REQUEST (400)" in {
            ...
            val res = postRequest("/ultimate-parent-company/1/sautr", Json.obj("value" -> ""))()
  ...
  "in Change mode" when {
    ...
    "GET /ultimate-parent-company/1/sautr/change" when {
      ...
      "user is authorised" should {
        ...
        "user answer for parent company name exists" should {
          ...
          "return OK (200)" in {
            ...
            val res = getRequest("/ultimate-parent-company/1/sautr/change")()
      ...
      "user is authorised" when {
        ...
        "enters a valid answer" when {
          ...
          "redirect to CheckYourAnswers page" in {
            ...
            val res = postRequest("/ultimate-parent-company/1/sautr/change", Json.obj("value" -> "1111111111"))()
        ...
        "enters an invalid answer" when {
          ...
          "return a BAD_REQUEST (400)" in {
            ...
            val res = postRequest("/ultimate-parent-company/1/sautr/change", Json.obj("value" -> ""))()
