...
class FullOrAbbreviatedReturnControllerISpec extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers with BaseITConstants {
  ...
  "in Normal mode" when {
    ...
    "GET /about-the-return/full-or-abbreviated-return" when {
      ...
      "user is authorised" should {
        ...
        "return OK (200)" in {
          ...
          val res = getRequest("/about-the-return/full-or-abbreviated-return")()
    ...
    "POST /about-the-return/full-or-abbreviated-return" when {
      ...
      "user is authorised" when {
        ...
        "enters a valid answer" when {
          ...
          "redirect to ReportingCompanyName page" in {
            ...
            val res = postRequest("/about-the-return/full-or-abbreviated-return", Json.obj("value" -> Full.toString))()
    ...
    "GET /about-the-return/full-or-abbreviated-return" when {
      ...
      "user is authorised" should {
        ...
        "return OK (200)" in {
          ...
          val res = getRequest("/about-the-return/full-or-abbreviated-return/change")()
