...
class AccountingPeriodStartControllerISpec extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers with BaseITConstants {
  ...
  "in Normal mode" when {
    ...
    "GET /about-the-return/accounting-period-start" when {
      ...
      "user is authorised" should {
        ...
        "return OK (200)" in {
          ...
          AuthStub.authorised()
          val res = getRequest("/about-the-return/accounting-period-start")()
    ...
    "POST /about-the-return/accounting-period-end" when {
      ...
      "user is authorised" when {
        ...
        "enters a valid answer" when {
          ...
          "redirect to AccountingPeriodEnd Page" in {
            ...
            val res = postRequest("/about-the-return/accounting-period-start",
      ...
      "user not authorised" should {
        ...
        "return SEE_OTHER (303)" in {
          ...
          val res = postRequest("/about-the-return/accounting-period-start", Json.obj("value" -> ""))()
    ...
    "GET /about-the-return/accounting-period-start" when {
      ...
      "user is authorised" should {
        ...
        "return OK (200)" in {
          ...
          val res = getRequest("/about-the-return/accounting-period-start/change")()
