...
class InterestReactivationsCapControllerISpec extends IntegrationSpecBase with CreateRequestHelper with CustomMatchers with BaseITConstants {
  ...
  "in Normal mode" when {
    ...
    "GET /group-level-information/interest-reactivations-cap" when {
      ...
      "user is authorised" should {
        ...
        "return OK (200)" in {
          ...
          val res = getRequest("/group-level-information/interest-reactivations-cap")()
    ...
    "POST /group-level-information/interest-reactivations-cap" when {
      ...
      "user is authorised" when {
        ...
        "enters a valid answer" when {
          ...
          "redirect to InterestAllowanceBroughtForward page" in {
            ...
            val res = postRequest("/group-level-information/interest-reactivations-cap", Json.obj("value" -> 1))()
    ...
    "GET /group-level-information/interest-reactivations-cap" when {
      ...
      "user is authorised" should {
        ...
        "return OK (200)" in {
          ...
          val res = getRequest("/group-level-information/interest-reactivations-cap/change")()
