...
class $className;format="cap"$Spec extends WordSpec with MustMatchers with ScalaCheckPropertyChecks with OptionValues with ModelGenerators {

  "$className;format="cap"$" must {

    "deserialise valid values" in {

      val gen = arbitrary[$className;format="cap"$]
