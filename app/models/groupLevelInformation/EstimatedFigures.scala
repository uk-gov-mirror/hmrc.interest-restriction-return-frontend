...
object EstimatedFigures extends Enumerable.Implicits {
  ...
  val values: Seq[EstimatedFigures] = Seq(
    Angie, Qngie, GroupTaxEBITDA, ReactivationCap, TotalDisallowedAmount, InterestAllowanceBroughtForward, InterestAllowanceForThePeriodOfAccount, InterestCapacity
  )
