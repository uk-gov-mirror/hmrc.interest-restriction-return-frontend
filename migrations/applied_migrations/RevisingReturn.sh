...
echo "GET        /revisingReturn                        controllers.aboutReportingCompany.RevisingReturnController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /revisingReturn                        controllers.aboutReportingCompany.RevisingReturnController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeRevisingReturn                  controllers.aboutReportingCompany.RevisingReturnController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeRevisingReturn                  controllers.aboutReportingCompany.RevisingReturnController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
