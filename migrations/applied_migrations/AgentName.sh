...
echo "GET        /agentName                        controllers.aboutReturn.AgentNameController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /agentName                        controllers.aboutReturn.AgentNameController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeAgentName                  controllers.aboutReturn.AgentNameController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeAgentName                  controllers.aboutReturn.AgentNameController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
