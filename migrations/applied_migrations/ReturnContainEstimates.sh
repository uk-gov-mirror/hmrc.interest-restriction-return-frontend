...
echo "GET        /returnContainEstimates                        controllers.ReturnContainEstimatesController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /returnContainEstimates                        controllers.ReturnContainEstimatesController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeReturnContainEstimates                  controllers.ReturnContainEstimatesController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeReturnContainEstimates                  controllers.ReturnContainEstimatesController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
