...
echo "GET        /checkAnswersReportingCompany                        controllers.CheckAnswersReportingCompanyController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /checkAnswersReportingCompany                        controllers.CheckAnswersReportingCompanyController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeCheckAnswersReportingCompany                  controllers.CheckAnswersReportingCompanyController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeCheckAnswersReportingCompany                  controllers.CheckAnswersReportingCompanyController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
