...
echo "object InterestAllowanceBroughtForwardTemplate extends WithName(\"interestAllowanceBroughtForward.njk\") with ViewTemplate" >> ../app/nunjucks/ViewTemplate.scala
