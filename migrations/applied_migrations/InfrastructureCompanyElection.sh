...
echo "object InfrastructureCompanyElectionTemplate extends WithName(\"infrastructureCompanyElection.njk\") with ViewTemplate" >> ../app/nunjucks/ViewTemplate.scala
