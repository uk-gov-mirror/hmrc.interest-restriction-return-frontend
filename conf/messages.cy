...
# ----------------------------------------------------------
partnershipSAUTR.title = Enter {0} Self Assessment Unique Taxpayer Reference
partnershipSAUTR.heading = Enter {0} Self Assessment Unique Taxpayer Reference
...
derivedCompany.t3-expense = Aggregate net tax-interest expensea
