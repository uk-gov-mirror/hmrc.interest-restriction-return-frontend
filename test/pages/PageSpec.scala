...
class PageSpec extends SpecBase {
  ...
  "Page" must {
    ...
    "Have a mapping between all possible pages (as String) to pages" in {
      ...
      val expected = Map(
    RestrictionAmountForAccountingPeriodPage.toString -> RestrictionAmountForAccountingPeriodPage,
        ...
        CompanyQICElectionPage.toString -> CompanyQICElectionPage,
        EstimatedFiguresPage.toString -> EstimatedFiguresPage,
