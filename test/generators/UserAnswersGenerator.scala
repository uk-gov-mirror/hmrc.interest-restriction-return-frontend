...
trait UserAnswersGenerator extends TryValues {
  ...
  val generators: Seq[Gen[(QuestionPage[_], JsValue)]] =
    ...
    arbitrary[(AccountingPeriodPage.type, JsValue)] ::
