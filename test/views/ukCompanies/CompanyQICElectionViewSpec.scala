...
class CompanyQICElectionViewSpec extends YesNoViewBehaviours  {

  val messageKeyPrefix = "companyQICElection"
  val section = Some(messages("section.ukCompanies"))
  val form = new CompanyQICElectionFormProvider()()

    "CompanyQICElectionView" must {

      def applyView(form: Form[_]): HtmlFormat.Appendable = {
        val view = viewFor[CompanyQICElectionView](Some(emptyUserAnswers))
