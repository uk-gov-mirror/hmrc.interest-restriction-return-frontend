...
class EnterQNGIEViewSpec extends DecimalViewBehaviours  {

  val messageKeyPrefix = "enterQNGIE"
  ...
  val form = new EnterQNGIEFormProvider()()
    ...
    "EnterQNGIEView" must {
      ...
      def applyView(form: Form[_]): HtmlFormat.Appendable = {
          val view = viewFor[EnterQNGIEView](Some(emptyUserAnswers))
      ...
      behave like decimalPage(form, applyView, messageKeyPrefix, routes.EnterQNGIEController.onSubmit(NormalMode).url, section = section)
