...
class AgentDetailsControllerSpec extends SpecBase with MockNunjucksRenderer with NunjucksSupport with FeatureSwitching {

  val view = injector.instanceOf[agentDetailsView]
  ...
  "AgentDetails Controller" must {
    ...
    "If rendering using the Nunjucks templating engine" must {
      ...
      "return OK and the correct view for a GET" in {
        ...
        mockRender(AgentDetailsTemplate, viewContext(form))(Html("Success"))
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AgentDetailsPage, true).success.value
