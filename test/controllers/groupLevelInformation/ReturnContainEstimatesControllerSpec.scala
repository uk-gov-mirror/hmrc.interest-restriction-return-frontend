...
import pages.groupLevelInformation.ReturnContainEstimatesPage
import play.api.test.Helpers._
import views.html.groupLevelInformation.ReturnContainEstimatesView

class ReturnContainEstimatesControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[ReturnContainEstimatesView]
  val formProvider = injector.instanceOf[ReturnContainEstimatesFormProvider]
