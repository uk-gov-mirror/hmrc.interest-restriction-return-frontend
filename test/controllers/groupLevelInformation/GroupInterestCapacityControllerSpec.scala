...
import views.html.groupLevelInformation.GroupInterestCapacityView

class GroupInterestCapacityControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[GroupInterestCapacityView]
  val formProvider = injector.instanceOf[GroupInterestCapacityFormProvider]
  val form = formProvider()
  val validAnswer = 0

  object Controller extends GroupInterestCapacityController(
