...
class PartnershipNameControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[PartnershipNameView]
  val formProvider = injector.instanceOf[PartnershipNameFormProvider]
  ...
  "PartnershipName Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(PartnershipNamePage, "answer").success.value
