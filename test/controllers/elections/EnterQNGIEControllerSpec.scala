...
class EnterQNGIEControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[EnterQNGIEView]
  val formProvider = injector.instanceOf[EnterQNGIEFormProvider]
  ...
  "EnterQNGIE Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set[BigDecimal](EnterQNGIEPage, validAnswer).success.value
