...
class EnterANGIEControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {
  ...
  val view = injector.instanceOf[EnterANGIEView]
  val formProvider = injector.instanceOf[EnterANGIEFormProvider]
  ...
  "EnterANGIE Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set[BigDecimal](EnterANGIEPage, validAnswer).success.value
