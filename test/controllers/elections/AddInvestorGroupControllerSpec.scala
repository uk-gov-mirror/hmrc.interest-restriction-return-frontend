...
class AddInvestorGroupControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[AddInvestorGroupView]
  val formProvider = injector.instanceOf[AddInvestorGroupFormProvider]
  ...
  "AddInvestorGroup Controller" must {
