...
class GroupRatioElectionControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[GroupRatioElectionView]
  val formProvider = injector.instanceOf[GroupRatioElectionFormProvider]
  ...
  "GroupRatioElection Controller" must {
