...
class ReportingCompanyResultControllerSpec extends SpecBase with MockNunjucksRenderer with NunjucksSupport with FeatureSwitching {
  ...
  def controller(dataRetrieval: DataRetrievalAction = FakeDataRetrievalActionEmptyAnswers) = new ReportingCompanyResultController(
    ...
    formProvider = new ReportingCompanyResultFormProvider,
  ...
  "ReportingCompanyResult Controller" must {
    ...
    "If rendering using the Nunjucks templating engine" must {
      ...
      "return OK and the correct view for a GET" in {
        ...
        mockRender(ReportingCompanyResultTemplate, viewContext(form))(Html("Success"))
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ReportingCompanyResultPage, true).success.value
