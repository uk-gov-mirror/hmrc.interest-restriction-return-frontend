...
class TellUsWhatHasChangedControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[TellUsWhatHasChangedView]
  val formProvider = injector.instanceOf[TellUsWhatHasChangedFormProvider]
  ...
  "TellUsWhatHasChanged Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(TellUsWhatHasChangedPage, "answer").success.value
