...
class ReportingCompanyAppointedControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[ReportingCompanyAppointedView]
  val formProvider = injector.instanceOf[ReportingCompanyAppointedFormProvider]
  val form = formProvider()

  object Controller extends ReportingCompanyAppointedController(
