...
class LocalRegistrationNumberControllerSpec extends SpecBase with FeatureSwitching with BaseConstants with MockDataRetrievalAction {

  val view = injector.instanceOf[LocalRegistrationNumberView]
  val formProvider = injector.instanceOf[LocalRegistrationNumberFormProvider]
  val form = formProvider()

  object Controller extends LocalRegistrationNumberController(
