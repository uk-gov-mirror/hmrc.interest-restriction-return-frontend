...
class RegisteredCompaniesHouseControllerSpec extends SpecBase with FeatureSwitching {

  val view = injector.instanceOf[RegisteredCompaniesHouseView]
  val formProvider = new RegisteredCompaniesHouseFormProvider
  val form = formProvider()

  def controller(dataRetrieval: DataRetrievalAction = FakeDataRetrievalActionEmptyAnswers) = new RegisteredCompaniesHouseController(
    ...
    formProvider = new RegisteredCompaniesHouseFormProvider,
    controllerComponents = messagesControllerComponents,
    view = view
  )

  "RegisteredCompaniesHouse Controller" must {
