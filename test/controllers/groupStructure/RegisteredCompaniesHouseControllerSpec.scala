...
class RegisteredCompaniesHouseControllerSpec extends SpecBase with FeatureSwitching with MockDataRetrievalAction {

  val view = injector.instanceOf[RegisteredCompaniesHouseView]
  val formProvider = injector.instanceOf[RegisteredCompaniesHouseFormProvider]
  val form = formProvider()

  object Controller extends RegisteredCompaniesHouseController(
